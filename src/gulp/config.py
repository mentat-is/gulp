...
async def initialize_custom_directories():
    ...
    GulpLogger.get_instance().debug("default_mapping_files_path: %s" % (default_mapping_files_path))
    GulpLogger.get_instance().debug("custom_mapping_files_path: %s" % (custom_mapping_files_path))
    GulpLogger.get_instance().debug("default_plugins_path: %s" % (default_plugins_path))
    GulpLogger.get_instance().debug("custom_plugins_path: %s" % (custom_plugins_path))
...
def _read_or_init_configuration(path: str = None) -> dict:
    ...
    GulpLogger.get_instance().info("configuration path: %s" % (_config_file_path))
