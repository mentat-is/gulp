...
class Plugin(PluginBase):
    ...
    async def record_to_gulp_document(
        ...
        **kwargs,
        ...
        field = 0
        fields=["rulenum", "subrulenum", "anchor", "tracker",
            "realint", "interface", "reason", "act", "direction", "version"]
        ...
        if flent["protoid"] in ["6", "17", "132"]:
            ...
            if flent["icmp_type"] in ["request", "reply"]:
                ...
                field+=1
            elif flent["icmp_type"] in ["unreach", "timexceed", "paramprob", "redirect", "maskreply"]:
                field+=1
                ...
                for rr in log_file:
                    try:
                        ...
                        if self.pattern.match(rr) is None:
                            fs = self._record_failed(fs, rr, source, f"Regex ({self.pattern}) did not match line ({rr})")
                            continue
