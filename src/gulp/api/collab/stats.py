...
#     )
#     operation: Mapped[str] = mapped_column(String, default=None, nullable=True)
...
#     )
#     client: Mapped[str] = mapped_column(String, default=None, nullable=True)
#     context: Mapped[str] = mapped_column(String, default=None, nullable=True)
#     context_id: Mapped[int] = mapped_column(
#         ForeignKey("context.id", ondelete="CASCADE"), default=None, nullable=True)
...
#     parser_failed: Mapped[int] = mapped_column(Integer, default=0)
...
class GulpStats(CollabBase):
    ...
    async def create(
        ...
        Args:
            ...
            client (str, optional): The client associated with the stats. Defaults to None.
            context (str, optional): The context associated with the stats. Defaults to None.
        Returns:
            GulpStats: The created CollabStats object.
        """
        logger().debug(
            "---> create: t=%s, operation=%s, client=%s, context=%s"
            % (t, operation, client, context)
        )
