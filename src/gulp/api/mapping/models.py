...
class GulpMapping(BaseModel):
    ...
    timestamp_field: Optional[str] = Field(None,
    ...
    timestamp_dayfirst: Optional[bool] = Field(None,
    ...
    timestamp_yearfirst: Optional[bool] = Field(None,
    ...
    timestamp_fuzzy: Optional[bool] = Field(None,
