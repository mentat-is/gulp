...
class GulpMapping(BaseModel):
    ...
    opt_agent_type: Optional[str] = Field(None,
    ...
    opt_event_code: Optional[str] = Field(None,
        description='if set, all documents generated by this mapping have "event.code" set to this value (and "gulp.event.code" to the corresponding numeric value). either, the plugin is responsible for setting this.',
    )
    opt_timestamp_field: Optional[str] = Field(None,
    ...
    opt_timestamp_dayfirst: Optional[bool] = Field(None,
    ...
    opt_timestamp_yearfirst: Optional[bool] = Field(None,
    ...
    opt_timestamp_fuzzy: Optional[bool] = Field(None,
