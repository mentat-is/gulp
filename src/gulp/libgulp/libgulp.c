...
static PyMethodDef ModuleMethods[] = {
    ...
    {"c_number_to_nanos_from_unix_epoch", c_number_to_nanos_from_unix_epoch, METH_VARARGS|METH_KEYWORDS, "convert various time formats to iso8601"},
    {"c_string_to_nanos_from_unix_epoch", c_string_to_nanos_from_unix_epoch, METH_VARARGS|METH_KEYWORDS, "convert various time formats to iso8601"},
