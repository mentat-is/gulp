...
static PyMethodDef ModuleMethods[] = {
    ...
    {"c_is_iso8601", c_is_iso8601, METH_VARARGS,
    ...
    {"c_chrome_epoch_to_nanos_from_unix_epoch",
     c_chrome_epoch_to_nanos_from_unix_epoch, METH_VARARGS,
     "C variant of muty.time.chrome_epoch_to_nanos_from_unix_epoch"},
