...
async def test_enrich_circl_hash_single_id():
    ...
    assert doc[f"{GulpOpenSearch.ENRICHED_PREFIX}"]["enrich_circl_hash"]["hash_md5"] != None
    assert doc[f"{GulpOpenSearch.ENRICHED_PREFIX}"]["enrich_circl_hash"]["hash_new_sha256"] != None
