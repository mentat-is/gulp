1. always provide commented code!
2. comments and debug messages should always be lowercase (except when the line/s are commented code, in this case the case must be preserved)
3. never lowercase TODO:, FIXME:, NOTE:, and similar comments
